...
`,
		...
		"object_create_sensitive_attribute": {
			change: Change{
				renderer: Object(map[string]Change{
					"attribute_one": {
						renderer: Sensitive(nil, 1.0, false, true),
						action:   plans.Create,
					},
				}),
				action: plans.Update,
...
`,
		...
		"map_update_sensitive_element": {
			change: Change{
				renderer: Map(map[string]Change{
					"element_one": {
						renderer: Sensitive(0.0, 1.0, true, true),
						action:   plans.Update,
					},
				}),
				action: plans.Update,
...
`,
		...
		"map_update_sensitive_element_status": {
			change: Change{
				renderer: Map(map[string]Change{
					"element_one": {
						renderer: Sensitive(0.0, 0.0, true, false),
						action:   plans.Update,
					},
				}),
				action: plans.Update,
...
`,
		...
		"map_delete_sensitive_element": {
			change: Change{
				renderer: Map(map[string]Change{
					"element_one": {
						renderer: Sensitive(0.0, nil, true, false),
						action:   plans.Delete,
					},
				}),
				action: plans.Update,
...
`,
		...
		"list_delete_sensitive_element": {
			change: Change{
				renderer: List([]Change{
					{
						renderer: Sensitive(1.0, nil, true, false),
						action:   plans.Delete,
					},
				}),
				action: plans.Update,
...
`,
		...
		"list_update_sensitive_element_status": {
			change: Change{
				renderer: List([]Change{
					{
						renderer: Sensitive(1.0, 1.0, false, true),
						action:   plans.Update,
					},
				}),
				action: plans.Update,
...
`,
		...
		"set_update_sensitive_element_status": {
			change: Change{
				renderer: Set([]Change{
					{
						renderer: Sensitive(1.0, 2.0, false, true),
						action:   plans.Update,
					},
				}),
				action: plans.Update,
...
`,
	...
	for name, tc := range tcs {
		t.Run(name, func(t *testing.T) {
			...
			actual := colorize.Color(tc.change.Render(0.0, tc.opts))
